...
// integrali1laba.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cintegrali1labaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание Cintegrali1labaApp

Cintegrali1labaApp::Cintegrali1labaApp()
{
...
// Единственный объект Cintegrali1labaApp

Cintegrali1labaApp theApp;


// Инициализация Cintegrali1labaApp

BOOL Cintegrali1labaApp::InitInstance()
{
